...
namespace Infrastructure.Persistence.Migrations.Identity
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedByUserId = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EmailNotification = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValueSql: "1"),
                    ToasterNotification = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValueSql: "1"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_EmailNotification",
                table: "AspNetUsers",
                column: "EmailNotification");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ToasterNotification",
                table: "AspNetUsers",
                column: "ToasterNotification");
